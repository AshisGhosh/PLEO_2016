...
forward public blank_init();
forward public blank_eval();
forward public blank_behavior_eval(behavior_id);
forward public blank_exit();
forward public blank_activate();
forward public blank_deactivate();
...
public blank_init()
{
    ...
    behavior_add(scr_home, "blank", 0, 100, 100, 100, 1000);
...
//
public blank_behavior_eval(behavior_id)
{
